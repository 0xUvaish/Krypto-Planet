...
const CryptoDetails = () => {
    ...
    // console.log(cryptoDetails?.numberOfMarkets);
    // console.log(String(cryptoDetails?.allTimeHigh?.price));
            ...
            <Col className="stats-container">
                ...
                <Col className="coin-value-statistics">
                    <Col className="coin-value-statistics-heading">
                        <Title level={3} className="coin-details-heading-black">
                ...
                <Col className="other-stats-info">
                    <Col className="coin-value-statistics-heading">
                        ...
                        <p>An overview showing all the stats of this cryptocurrency</p>
                    </Col>
